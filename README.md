...
- Contributor: [Sourcegraph](https://github.com/sourcegraph/sourcegraph) which has 9.2k stars. Here are my [contributions](https://github.com/ibilalkayy/PR-Journey/blob/main/Projects/Sourcegraph.md).
